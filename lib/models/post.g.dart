...
extension PostQueryWhereSort on QueryBuilder<Post, Post, QWhere> {
  ...
  QueryBuilder<Post, Post, QAfterWhere> anyIsSynced() {
    return QueryBuilder.apply(this, (query) {
...
extension PostQueryWhere on QueryBuilder<Post, Post, QWhereClause> {
  ...
  QueryBuilder<Post, Post, QAfterWhereClause> isSyncedEqualTo(bool isSynced) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Post, Post, QAfterWhereClause> isSyncedNotEqualTo(
      bool isSynced) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension PostQueryFilter on QueryBuilder<Post, Post, QFilterCondition> {
  ...
  QueryBuilder<Post, Post, QAfterFilterCondition> syncedAtIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Post, Post, QAfterFilterCondition> syncedAtIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Post, Post, QAfterFilterCondition> syncedAtEqualTo(
      DateTime? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'syncedAt',
  ...
  QueryBuilder<Post, Post, QAfterFilterCondition> syncedAtGreaterThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Post, Post, QAfterFilterCondition> syncedAtLessThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Post, Post, QAfterFilterCondition> syncedAtBetween(
    DateTime? lower,
    DateTime? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension PostQuerySortBy on QueryBuilder<Post, Post, QSortBy> {
  ...
  QueryBuilder<Post, Post, QAfterSortBy> sortBySyncedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'syncedAt', Sort.asc);
    });
  }

  QueryBuilder<Post, Post, QAfterSortBy> sortBySyncedAtDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension PostQuerySortThenBy on QueryBuilder<Post, Post, QSortThenBy> {
  ...
  QueryBuilder<Post, Post, QAfterSortBy> thenBySyncedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'syncedAt', Sort.asc);
    });
  }

  QueryBuilder<Post, Post, QAfterSortBy> thenBySyncedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'syncedAt', Sort.desc);
    });
  }
...
extension PostQueryWhereDistinct on QueryBuilder<Post, Post, QDistinct> {
  ...
  QueryBuilder<Post, Post, QDistinct> distinctBySyncedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension PostQueryProperty on QueryBuilder<Post, Post, QQueryProperty> {
  ...
  QueryBuilder<Post, DateTime?, QQueryOperations> syncedAtProperty() {
    return QueryBuilder.apply(this, (query) {
